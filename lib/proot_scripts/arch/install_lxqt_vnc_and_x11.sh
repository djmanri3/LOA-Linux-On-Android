...
pacman -S --noconfirm xorg lightdm $ui_package dolphin icu chromium pulseaudio sudo $vnc_package
echo
...
echo -e "- Configure "$b"password$n to conect "$b"VNC$n..."
vncpasswd
#echo -e "- Config "$b"VNC$n..."
#echo "geometry=1920x1080" > /etc/tigervnc/vncserver-config-defaults
EOF
