...
function gen_install {
	...
	echo "pacman -S --noconfirm xorg sddm $ui_package dolphin icu chromium pulseaudio sudo $vnc_package" >> $proot_folder/root/$ui_install
	echo "echo">> $proot_folder/root/$ui_install
...
function gen_startvnc {
        ...
        echo "echo $ui_vnc > ~/.vnc/xstartup" >> $proot_in/vncstart
